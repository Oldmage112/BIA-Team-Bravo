...
## Project Overview
This 5‑week project analyzes labour market and economic trends in Nova Scotia, with a focus on employment, unemployment, wages, industry performance, workforce participation and payday loan. Using publicly available data from Statistics Canada, Nova Scotia Open Data sources, the project examines how recent economic pressures and structural changes have affected workforce outcomes at the provincial level, while using other provinces as comparative reference points.
